...
public abstract class RangedWeapon : Weapon
{
    ...
    [SerializeField] private Vector2 _pivotOriginPos; //루트의 자식일때의 피벗 포지
    ...
    {
        animator?.PlayUpperBodyAnimation(RangedData.upperBodyIdleAnim);
        ...
        firePoint.transform.localPosition = _pivotOriginPos;
        if (_reloadCoroutine != null)
        {
            StopCoroutine(_reloadCoroutine);
            _reloadCoroutine = null;
