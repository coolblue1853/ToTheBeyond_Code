...
public class PlayerWeaponHandler : MonoBehaviour
{
    ...
    public void ResetWeapon()
    {
        ...
        elementController.weaponElementType = worldWeapon.weaponComponent.data.elementType;
        elementController.weaponType = worldWeapon.weaponComponent.data.weaponType;
        isFusion = false;
    }
