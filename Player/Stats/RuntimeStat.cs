...
public class RuntimeStat : IStatProvider, IDamageStatProvider
{
    ...
    public void NotifyStatChanged(StatType type)
    {
    ...
    public float BasicAttackDamage => GetValue(StatType.BasicAttackDamage, baseStats.BasicAttackDamage) + PermanentUpgradeManager.Instance.GetUpgradeBonus(StatType.BaseDamage);
